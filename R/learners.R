...
#' \code{glmnet} metalearner class
#'
#' @export Metalearner_glmnet
#' @exportClass Metalearner_glmnet
Metalearner_glmnet <- setRefClass(
  "Metalearner_glmnet",
  fields = list(
    covariates = "character",
    treatment = "character",
  ...
  methods = list(
    ...
    initialize = function(covariates = NULL,
      ...
      .self$fit_arguments[['family']] <- poisson(link = "identity")
    ...
    fit = function(data, ...) {
      ...
      if(!.self$penalise_nodes){
        ...
        .self$fit_arguments[['penalty.factor']] <- 1- (grepl("node",colnames(x))& !grepl(":", colnames(x)))
...
#' \code{glm} metalearner class
#'
#' @export Metalearner_glm
#' @exportClass Metalearner_glm
Metalearner_glm <- setRefClass(
  "Metalearner_glm",
  fields = list(
    covariates = "character",
    treatment = "character",
